...
#r @"E:\oldC\R2\Tools\SuperEmbeddedWebServer\SuperWebSocket\bin\Release\SuperWebSocket.dll"
...
#r @"E:\oldC\R2\Tools\SuperEmbeddedWebServer\SuperWebSocket\bin\Release\SuperSocket.SocketBase.dll"
#r @"E:\oldC\R2\Tools\SuperEmbeddedWebServer\SocketEngine\bin\Release\SuperSocket.SocketEngine.dll"
#r @"E:\oldC\R2\Tools\SuperEmbeddedWebServer\SuperWebSocket\bin\Release\SuperSocket.Common.dll"

// Crude web server - serves http requests as well as services web-socket requests
#r @"E:\oldC\R2\Tools\SuperEmbeddedWebServer\SuperEmbeddedWebServer\bin\Debug\SuperEmbeddedWebServer.dll"

// SuperEmbeddedWebServer wrapper to make it friendlier to the F# interactive.
#r @"E:\oldC\R2\Tools\SuperEmbeddedWebServer\FSharp.EmbededWebServer\bin\Debug\FSharp.EmbededWebServer.dll"

// Our web server uses log4net
#r @"E:\oldC\R2\Tools\SuperEmbeddedWebServer\packages\log4net.2.0.3\lib\net40-full\log4net.dll"
